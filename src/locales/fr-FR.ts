...
export default {
  ...
  'menu.Courses.Acces aux cours': 'Accès aux cours',
  'menu.Courses.Quiz Reports': 'Rapports de quiz',
  'menu.Courses.Details': 'Détails',
  'menu.Users.Notifications': 'Notifications',
  'menu.My Profile': 'Mon profil',
  'menu.My Profile.My Profile': 'Mon profil',
  'menu.Teacher': 'Enseignant',
  'menu.Teacher.Subjects': 'Matières',
  'menu.Teacher.Form': 'Formulaire',
  'menu.Teacher.Subject Form': 'Formulaire de matière',
  'menu.Competency challenges': 'Défis de compétences',
  'menu.Competency challenges.List': 'Liste',
  'menu.Competency challenges.Competency challenge': 'Défi de compétence',
  'menu.Other activities.Consultation Requests': 'Demandes de consultation',
